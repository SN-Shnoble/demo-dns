...
return new class extends Migration {
     ...
     * 在 active.json 里按 IP 路由。ProfileConfigBuilder::mapDevice 已经支持
     * $device['source_ip'] 字段，但 dns_devices 之前只有 ip_hash。
     */
    public function up(): void
    {
        Schema::table('devices', function (Blueprint $table) {
            $table->string('source_ip', 45)->nullable()->after('ip_hash')->comment('plaintext client IP used for profile->IP routing in active.json; do not log');
